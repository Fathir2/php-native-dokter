...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE tb_dokter SET nama_dokter='$nama_dokter', id_spesialis='$id_spesialis', telepon='$telepon', sex='$sex' WHERE kd_dokter='$kd_dokter'";
...
<div class="container mt-5">
    ...
    <form method="POST" action="">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="id_spesialis" name="id_spesialis" value="<?php echo $id_spesialis; ?>" required>
        </div>
        <div class="form-group">
