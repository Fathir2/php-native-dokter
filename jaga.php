...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO tb_jaga (Id_dokter, hari, jam_mulai, jam_selesai) VALUES ('$Id_dokter', '$hari', '$jam_mulai', '$jam_selesai')";
...
$sql = "SELECT Id_dokter, hari, jam_mulai, jam_selesai FROM tb_jaga";
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                echo "<tr>
                    ...
                    <td>
                    <a href='editjaga.php?Id_dokter={$row['Id_dokter']}' class='btn btn-warning btn-sm'>Edit</a>
                    <a href='deletejaga.php?Id_dokter={$row['Id_dokter']}' class='btn btn-danger btn-sm'>Delete</a>
                </td>
