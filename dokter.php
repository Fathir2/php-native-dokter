...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO tb_dokter (kd_dokter, nama_dokter, id_spesialis, telepon, sex) VALUES ('$kd_dokter', '$nama_dokter', '$id_spesialis', '$telepon', '$sex')";
...
$sql = "SELECT kd_dokter, nama_dokter, id_spesialis, telepon, sex FROM tb_dokter";
...
<div class="container mt-5">
    ...
    <form method="POST" action="">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="id_spesialis" name="id_spesialis" required>
        </div>
        <div class="form-group">
