...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE tb_jaga SET hari='$hari', jam_mulai='$jam_mulai', jam_selesai='$jam_selesai' WHERE Id_dokter='$Id_dokter'";
    ...
    $sql = "SELECT hari FROM tb_jaga WHERE Id_dokter='$Id_dokter'";
...
<div class="container mt-5">
    ...
    <form method="POST" action="">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="Id_dokter" name="Id_dokter" value="<?php echo $Id_dokter; ?>" readonly>
        </div>
        <div class="form-group">
